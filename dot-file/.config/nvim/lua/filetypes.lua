...
autocmd({ "BufNew", "BufNewFile", "BufRead" }, "*.ejs", function()
	vim.o.filetype = "ejs"
end)
autocmd("Filetype", "ejs", function()
	vim.o.syntax = "html"
end)

-- nginx
autocmd({ "BufNew", "BufNewFile", "BufRead" }, "/etc/nginx/*,/usr/local/nginx/conf/*", function()
	vim.o.filetype = "nginx"
end)

-- nas
autocmd({ "BufNew", "BufNewFile", "BufRead" }, "*.nas", function()
	vim.o.filetype = "nasm"
end)

-- arista
autocmd({ "BufNew", "BufNewFile", "BufRead" }, "*.desc", function()
	vim.o.syntax = "json"
end)
